...
SOAR_LABEL_CORRECTIONS = files("robometer.dataset_upload.dataset_helpers").joinpath(
    "soar_label_corrections_full.json"
)
...
def convert_soar_dataset_to_hf(
    ...
    label_corrections = {}
    if SOAR_LABEL_CORRECTIONS.is_file():
        with SOAR_LABEL_CORRECTIONS.open() as f:
            data = json.load(f)
