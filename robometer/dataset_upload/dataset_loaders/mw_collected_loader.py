...
uv run python -m robometer.dataset_upload.generate_hf_dataset \
    --config_path=robometer/dataset_upload/configs/data_gen_configs/metaworld.yaml
"""
...
from robometer.dataset_upload.dataset_loaders.mw_task_annotations import EVAL_GT_ANN, TRAIN_GT_ANN
from robometer.dataset_upload.video_helpers import load_video_frames
