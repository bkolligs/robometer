...
```bash
uv run python -m robometer.dataset_upload.generate_hf_dataset --config_path=robometer/dataset_upload/configs/data_gen_configs/hand_paired.yaml --dataset.dataset_name hand_paired_robot
uv run python -m robometer.dataset_upload.generate_hf_dataset --config_path=robometer/dataset_upload/configs/data_gen_configs/hand_paired.yaml --dataset.dataset_name hand_paired_human
```
