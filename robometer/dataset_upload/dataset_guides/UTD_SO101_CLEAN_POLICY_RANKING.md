...
File: `robometer/dataset_upload/configs/data_gen_configs/utd_so101_clean_policy_ranking_wrist.yaml`
...
File: `robometer/dataset_upload/configs/data_gen_configs/utd_so101_clean_policy_ranking_top.yaml`
...
uv run python -m robometer.dataset_upload.generate_hf_dataset \
    --config_path=robometer/dataset_upload/configs/data_gen_configs/utd_so101_clean_policy_ranking_wrist.yaml
```
...
```bash
uv run python -m robometer.dataset_upload.generate_hf_dataset \
    --config_path=robometer/dataset_upload/configs/data_gen_configs/utd_so101_clean_policy_ranking_top.yaml
```
