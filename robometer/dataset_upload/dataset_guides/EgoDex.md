...
```bash
bash robometer/dataset_upload/data_scripts/egodex/download_and_convert.sh

# or run the following manually
uv run python -m robometer.dataset_upload.generate_hf_dataset --config_path=robometer/dataset_upload/configs/data_gen_configs/egodex.yaml
```

### Option 2: Manual Configuration
```bash
uv run python -m robometer.dataset_upload.generate_hf_dataset \
    --config_path=robometer/dataset_upload/configs/data_gen_configs/egodex.yaml \
...
Edit `robometer/dataset_upload/configs/data_gen_configs/egodex.yaml`:
