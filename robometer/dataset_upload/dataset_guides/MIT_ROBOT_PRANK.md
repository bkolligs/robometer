...
Configuration file: `robometer/dataset_upload/configs/data_gen_configs/mit_robot_prank.yaml`
...
```bash
uv run python -m robometer.dataset_upload.generate_hf_dataset --config_path=robometer/dataset_upload/configs/data_gen_configs/mit_franka_prank.yaml
```
