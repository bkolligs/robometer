...
```bash
uv run python -m robometer.dataset_upload.generate_hf_dataset --config_path=robometer/dataset_upload/configs/data_gen_configs/oxe.yaml  --dataset.dataset_name oxe_<dataset_name>
```
- Using the provided script to generate all datasets:

```bash
bash robometer/dataset_upload/data_scripts/oxe/gen_all_oxe.sh
```
...
uv run python -m robometer.dataset_upload.generate_hf_dataset
    --config_path=robometer/dataset_upload/configs/data_gen_configs/oxe.yaml \
...
Edit `robometer/dataset_upload/configs/data_gen_configs/oxe.yaml`:
