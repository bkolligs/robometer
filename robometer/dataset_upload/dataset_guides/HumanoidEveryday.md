...
```bash
bash robometer/dataset_upload/data_scripts/humanoid_everyday/download_humanoid_everyday.sh
```
...
```bash
uv run python -m robometer.dataset_upload.generate_hf_dataset --config robometer/dataset_upload/configs/data_gen_configs/humanoid_everyday.yaml
```
