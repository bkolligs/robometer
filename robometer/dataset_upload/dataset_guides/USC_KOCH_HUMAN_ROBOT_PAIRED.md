...
bash robometer/dataset_upload/data_scripts/usc_koch_human_robot_paired/download_datasets.sh

# 2. Convert human demonstrations
uv run python -m robometer.dataset_upload.generate_hf_dataset \
    --config_path=robometer/dataset_upload/configs/data_gen_configs/usc_koch_human_robot_paired.yaml \
